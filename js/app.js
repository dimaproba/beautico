...
***************************************************************************** */
    ...
    const closeBtn = saleHeader.querySelector(".sale-header__close");
    closeBtn.addEventListener("click", (() => {
        saleHeader.classList.add("closed");
        saleHeader.addEventListener("transitionend", (() => {}));
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        const menuItem = document.querySelector(".menu__item:nth-child(4)");
        const submenu = document.querySelector(".menu__sublist");
        let isSubMenuVisible = false;
        function hideSubmenu() {
            submenu.style.opacity = "0";
            submenu.style.transform = "translate(500%, 0)";
        ...
        menuItem.addEventListener("click", (function() {
            ...
            isSubMenuVisible = isActive;
        }));
        document.addEventListener("click", (function(event) {
            const targetElement = event.target;
            const isClickInsideMenu = menuItem.contains(targetElement) || submenu.contains(targetElement);
            if (!isClickInsideMenu && isSubMenuVisible) hideSubmenu();
        }));
    }));
    const slider = document.querySelector(".gallery-page__gallery");
    let isDown = false;
    let startX;
    let scrollLeft;
    ...
    const slider2 = document.querySelector(".page-main__advantages");
    let isDown2 = false;
    let startX2;
    let scrollLeft2;
